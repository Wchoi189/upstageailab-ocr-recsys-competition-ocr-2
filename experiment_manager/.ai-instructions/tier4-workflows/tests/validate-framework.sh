...
mkdir -p experiment-tracker/experiments/20251217_1234_test
echo "test" > experiment-tracker/experiments/20251217_1234_test/TEST_FILE.md

git add experiment-tracker/experiments/20251217_1234_test/TEST_FILE.md 2>/dev/null
