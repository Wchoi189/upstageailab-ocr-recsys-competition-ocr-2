...
class PaddleOCRRecognizer(BaseRecognizer):
    ...
    def __init__(self, config: RecognizerConfig) -> None:
        ...
        try:
            ...
            raise ImportError("PaddleOCR is not installed. Install with: uv sync --extra recognition") from e
        ...
        try:
            ...
            self._loaded = True
            LOGGER.info(f"Initialized PaddleOCRRecognizer (lang={config.language}, gpu={use_gpu})")
    ...
    def recognize_batch(self, inputs: list[RecognitionInput]) -> list[RecognitionOutput]:
        ...
        try:
            ...
            return [RecognitionOutput(text="", confidence=0.0) for _ in inputs]
