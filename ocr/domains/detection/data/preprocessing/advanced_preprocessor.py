...
class AdvancedDocumentPreprocessor:
    ...
    .. deprecated:: 1.0
        Use :class:`~ocr.data.datasets.preprocessing.enhanced_pipeline.EnhancedDocumentPreprocessor` instead.
...
def create_legacy_office_lens_preprocessor(
    ...
    .. deprecated:: 1.0
        Use :func:`~ocr.data.datasets.preprocessing.enhanced_pipeline.create_office_lens_preprocessor` instead.
