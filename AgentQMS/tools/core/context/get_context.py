...
from AgentQMS.tools.utils.system.paths import get_docs_dir
...
Usage examples:
    ...
    PYTHONPATH=. python AgentQMS.tools/utilities/get_context.py --task "implement new feature"
    PYTHONPATH=. python AgentQMS.tools/utilities/get_context.py --type development
    PYTHONPATH=. python AgentQMS.tools/utilities/get_context.py --list-context-bundles

    # Legacy handbook index bundles (deprecated)
    PYTHONPATH=. python AgentQMS.tools/utilities/get_context.py --bundle bundle-name
    PYTHONPATH=. python AgentQMS.tools/utilities/get_context.py --list-bundles
"""
