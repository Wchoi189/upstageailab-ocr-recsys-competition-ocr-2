...
- `process_management.md` - Wrapper pointing to maintainers version
...
### Wrapper Files
- `process_management.md` - Wrapper pointing to `maintainers/process_management.md`
...
- **Resolved**: `process_management.md` duplication (wrapper created)
