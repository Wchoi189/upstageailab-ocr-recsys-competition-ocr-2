...
from .postprocess import decode_polygons_with_head
...
class PostprocessingPipeline:
    ...
    def process(
        ...
        # Stage 2: Fallback removed (Legacy detection logic)
        # If head decoding fails, we return None.
        if self._settings is None:
             LOGGER.warning("Head decoding failed and no fallback settings available.")
