...
uv run python scripts/generate_assessment.py \
    --vlm-reports outputs/vlm_analysis/ \
    --output .metadata/assessments/20251219_XXXX_assessment_border-removal-validation.md
```
