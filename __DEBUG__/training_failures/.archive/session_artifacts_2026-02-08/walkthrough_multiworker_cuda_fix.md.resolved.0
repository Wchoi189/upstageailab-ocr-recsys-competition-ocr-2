...
**[test_cuda_environment.py](file:///workspaces/__DEBUG__/training_failures/scripts/test_cuda_environment.py)** - Verified:
- ✅ PyTorch 2.6.0+cu124, CUDA 12.4, RTX 3090
- ✅ Basic CUDA operations work
- ✅ Driver compatible (581.80/13.0)

**[test_dataloader_workers.py](file:///workspaces/__DEBUG__/training_failures/scripts/test_dataloader_workers.py)** - Tested:
...
**LMDB Dataset** ([ocr/domains/recognition/data/lmdb_dataset.py](file:///workspaces/ocr/domains/recognition/data/lmdb_dataset.py)):
- ✅ Already has lazy env initialization in [__getitem__](file:///workspaces/__DEBUG__/training_failures/scripts/test_dataloader_workers.py#24-29)
- ⚠️ Opens/closes env in [__init__](file:///workspaces/ocr/domains/recognition/data/lmdb_dataset.py#17-41) (before fork) - minor concern but not the cause

**Missing Components:**
- ❌ No `worker_init_fn` to clear CUDA state
- ❌ No explicit multiprocessing start method
- 🎯 **Found:** Comments in [train.py](file:///workspaces/scripts/runners/train.py) about previous pickle issues with spawn
