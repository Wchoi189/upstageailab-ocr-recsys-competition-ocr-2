...
;              
CREATE USER IF NOT EXISTS "SA" SALT '833fb76d338d5e83' HASH 'ba76169ad55057c7b9623b7310802373031feba13d294c8ab5afd0d442995177' ADMIN;          
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "CREATED_AT", "ENABLED", "FORCE_PASSWORD_CHANGE", "HAS_COMPLETED_INITIAL_SETUP", "IS_FIRST_LOGIN", "OAUTH_GRANDFATHERED", "PASSWORD", "ROLE_NAME", "SSO_PROVIDER", "SSO_PROVIDER_ID", "UPDATED_AT", "USERNAME", "TEAM_ID") VALUES(1, NULL, 'web', TIMESTAMP '2025-12-22 03:09:18.863708', TRUE, FALSE, FALSE, TRUE, FALSE, '$2a$10$tzH6WlFI7X0MqwkRWaQRc.SooEKigtaDRG.5jmtQpHnG2R1rxnM.2', NULL, NULL, NULL, TIMESTAMP '2025-12-22 03:09:18.863734', 'admin', 1);     
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "CREATED_AT", "ENABLED", "FORCE_PASSWORD_CHANGE", "HAS_COMPLETED_INITIAL_SETUP", "IS_FIRST_LOGIN", "OAUTH_GRANDFATHERED", "PASSWORD", "ROLE_NAME", "SSO_PROVIDER", "SSO_PROVIDER_ID", "UPDATED_AT", "USERNAME", "TEAM_ID") VALUES(2, 'ca212e0c-4fbf-4cf1-ab60-9409667f43d5', 'web', TIMESTAMP '2025-12-22 03:09:19.016647', TRUE, FALSE, FALSE, FALSE, FALSE, '$2a$10$TkxXtzn1jvosb5UYvSXIveQydSaFSRnyrqtM.mAsgCtI0jDKo9m5u', NULL, NULL, NULL, TIMESTAMP '2025-12-22 03:09:19.094524', 'STIRLING-PDF-BACKEND-API-USER', 2);          
