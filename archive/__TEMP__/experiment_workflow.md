...
This guide explains how to reference and work with experiments in the experiment-tracker system.

## Naming Conventions

### Experiment-Tracker Reference

**Full Path**: `experiment-tracker/` (from project root)

**Short Reference**: `@experiment-tracker` or `experiment-tracker/`

**In Code/Documentation**: Use `experiment-tracker/` for clarity
...
**Example**: `experiment-tracker/experiments/20251122_172313_perspective_correction/`
...
experiment-tracker/experiments/20251122_172313_perspective_correction/
...
ls experiment-tracker/experiments/

# Or check the .current file
cat experiment-tracker/experiments/.current
```

**Step 2: Reference the experiment**

In conversation/documentation:
- **Full reference**: `experiment-tracker/experiments/20251122_172313_perspective_correction`
...
python experiment-tracker/scripts/add-task.py --description "Continue testing"

# Or specify experiment ID explicitly (if script supports it)
python experiment-tracker/scripts/record-artifact.py \
    --path output.jpg \
...
**Proposed script**: `experiment-tracker/scripts/resume-experiment.py`

```bash
# Resume by ID
python experiment-tracker/scripts/resume-experiment.py \
...
python experiment-tracker/scripts/resume-experiment.py --list
```
...
```python
# Full path
experiment_path = Path("experiment-tracker/experiments/20251122_172313_perspective_correction")
...
experiment-tracker/experiments/20251122_172313_perspective_correction/scripts/test.py

# Relative from experiment-tracker
...
- "experiment-tracker/experiments/perspective_correction" (may not exist)
...
cat experiment-tracker/experiments/20251122_172313_perspective_correction/.metadata/state.yml
...
# 4. Continue work
python experiment-tracker/scripts/add-task.py --description "Continue from where we left off"
```
...
python experiment-tracker/scripts/stash-incomplete.py
...
| Reference | In docs: `@<ID>` or full path | `experiment-tracker/experiments/<ID>` |
