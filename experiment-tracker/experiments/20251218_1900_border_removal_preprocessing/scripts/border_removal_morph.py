...
def remove_border_morph(
    ...
    *,
    ...
    # Expected algorithm: grayscale -> otsu -> morphology close/dilate -> contours -> bbox crop
    cropped = image
    confidence = 0.0

    processing_ms = (time.perf_counter() - start) * 1000.0
    metrics = BorderRemovalMetrics(method="morph", processing_time_ms=processing_ms, confidence=confidence)
