...
## AgentQMS Architecture Consolidation (2025-12-29)

### [2025-12-29 18:00] - Consolidated AgentQMS Architecture
**Scope**: Project structure, configuration, tooling
**Change**: Unified `.ai-instructions`, `.agentqms`, `AgentQMS` into single `AgentQMS/` root
**Impact**: "Zero-Archaeology" discoverability, simplified configuration management
**Refactoring**: Renamed `agent_tools` -> `tools`, `interface` -> `bin`, `knowledge` -> `docs`
**Cleanup**: Archived deprecated files to `AgentQMS/archive/`
