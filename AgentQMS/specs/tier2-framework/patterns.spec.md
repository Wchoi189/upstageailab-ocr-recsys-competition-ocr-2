...
# Hydra V5 Patterns Reference

> Design patterns, anti-patterns, and debugging guide for Hydra 1.3.2 V5.0 - load when debugging
...
failure_modes:
  double_namespacing:
    ...
    example_correct: "# configs/data/default.yaml\n# @package _group_\ntrain_num_samples:\
      \ 1000  # \u2705 Creates data.train_num_samples\n"
  ...
  cross_domain_contamination:
    ...
    example_problem: "# User runs recognition, but detection keys still active\npython\
      \ runners/train.py domain=recognition\n# \u2192 max_polygons key causes CUDA\
      \ allocation error\n"
...
integration:
  companion_standards:
    rules: AgentQMS/specs/tier2-framework/patterns.spec.md
