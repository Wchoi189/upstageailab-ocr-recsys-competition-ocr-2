...
- **BUG-20251112-013**: CUDA memory access errors from tensor shape/device mismatches (configuration validation gaps)#### 2. Synthetic Data Quality
...
- **BUG-20251112-001**: Dice loss assertion errors from predictions exceeding [0,1] bounds### ⚠️ Medium-Impact Gaps (Priority 2)
...
- **Data Corruption**: 26.5% of training images affected (BUG-20251110-001)
...
<parameter name="filePath">/workspaces/upstageailab-ocr-recsys-competition-ocr-2/docs/data_contract_assessment.md
