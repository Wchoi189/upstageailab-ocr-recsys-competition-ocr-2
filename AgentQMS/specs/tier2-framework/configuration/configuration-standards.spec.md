...
priority: 'critical'
updated: '2026-02-03'
description: 'Standards for safely handling OmegaConf configuration objects to prevent silent failures from invalid type checks.'
---

# Configuration Standards

> Standards for safely handling OmegaConf configuration objects to prevent silent failures from invalid type checks.
