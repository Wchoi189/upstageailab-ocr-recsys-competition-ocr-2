...
- ✅ `ocr/recognition/data/lmdb_dataset.py` - Moved from `ocr.data.datasets/`
...
- Updated config references: `ocr.data.datasets.lmdb_dataset` → `ocr.recognition.data.lmdb_dataset`
...
- ✅ `ocr/kie/trainer.py` - Moved from `ocr.core.lightning/kie_pl.py`
