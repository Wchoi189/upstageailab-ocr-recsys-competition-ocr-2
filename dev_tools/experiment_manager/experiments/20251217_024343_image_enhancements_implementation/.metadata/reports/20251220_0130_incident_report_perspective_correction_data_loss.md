...
1. **Production** (`ocr.core.utils/perspective_correction.py`, line 130):
...
### Visual Proof
Generated comparison images in `experiment_manager/experiments/20251217_024343_image_enhancements_implementation/outputs/full_pipeline_correct/`:
...
```python
# ocr.core.utils/perspective_correction.py (line 130-270)
...
**Steps**:
1. Copy `mask_only_edge_detector.py` to `ocr.core.utils/` (or merge into `perspective_correction.py`)
...
**Code Changes**:
- **Files modified**: 1 (`ocr.core.utils/perspective_correction.py`)
...
- [ ] Copy `mask_only_edge_detector.py` to `ocr.core.utils/`
...
### Related Files
- `ocr.core.utils/perspective_correction.py` (current production code)
- `experiment_manager/experiments/20251128_220100_perspective_correction/scripts/mask_only_edge_detector.py` (validated implementation)
- `experiment_manager/experiments/20251217_024343_image_enhancements_implementation/outputs/full_pipeline_correct/` (evidence images)
