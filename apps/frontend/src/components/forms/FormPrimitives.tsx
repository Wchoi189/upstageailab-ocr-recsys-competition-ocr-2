...
export interface TextInputProps extends Omit<FormFieldProps, "value" | "onChange"> {
  value: string;
...
export interface CheckboxProps extends Omit<FormFieldProps, "value" | "onChange"> {
  checked: boolean;
  onChange: (checked: boolean) => void;
}

export function Checkbox(props: CheckboxProps): React.JSX.Element {
  const { checked, onChange, label, help, disabled, error, tooltip } = props;
...
export interface SelectBoxProps extends Omit<FormFieldProps, "value" | "onChange"> {
  value: string;
  onChange: (value: string) => void;
...
export interface SliderProps extends Omit<FormFieldProps, "value" | "onChange"> {
  value: number;
  onChange: (value: number) => void;
  min: number;
  max: number;
