...
def main():
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("experiment_manager/experiments/20251218_1900_border_removal_preprocessing/outputs"))
    ...
    print(f"Collecting border cases...")
