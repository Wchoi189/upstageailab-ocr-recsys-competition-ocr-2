#!/bin/bash
# Script to run Test dataset splits with specific Tier/Key configuration

# Usage:
#   ./scripts/runners/run_test_splits.sh <START_SPLIT> <END_SPLIT> <TIER>
...
echo "Processing Test Splits $START to $END"
...
echo "Test Splits $START-$END processing completed."
