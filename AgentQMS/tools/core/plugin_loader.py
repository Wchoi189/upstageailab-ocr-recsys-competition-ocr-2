...
modular plugin system at AgentQMS.tools.core.plugins.

For new code, import directly from the plugins package:

    from AgentQMS.tools.core.plugins import (
        get_plugin_registry,
        get_plugin_loader,
        PluginLoader,
        PluginRegistry,
...
def main() -> int:
    ...
    from AgentQMS.tools.core.plugins.cli import main as cli_main
