...
class ArtifactMonitor:
    ...
    def generate_fix_suggestions(self, report: dict) -> str:
        ...
        suggestions.append("  python AgentQMS/agent_tools/documentation/update_artifact_indexes.py --all")
        suggestions.append("")
        suggestions.append("  # Validate specific file")
        suggestions.append("  python AgentQMS/agent_tools/compliance/validate_artifacts.py --file path/to/file.md")
