...
This directory contains example code, tutorials, and demonstrations for using the OCR system.

## 📚 Available Examples

<!-- TODO: Add examples as they are created -->
...
If you create a useful example, please:
1. Add it to this directory
2. Update this README
3. Include clear documentation
4. Test that it works with the latest version
