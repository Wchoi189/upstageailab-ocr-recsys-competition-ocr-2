...
class ImageEnhancementComparator:
    ...
    def __init__(self):
        ...
        self.methods = {
            ...
            "sepia_contrast": self._sepia_contrast,
        }
    ...
    def _sepia_contrast(self, img: np.ndarray) -> np.ndarray:
        """Apply sepia with contrast enhancement."""
        enhancer = SepiaEnhancer(method="contrast")
        results = enhancer.enhance(img)
        return results["contrast"][0]
